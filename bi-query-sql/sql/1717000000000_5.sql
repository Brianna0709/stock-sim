WITH host_survey AS (
    ...
    WHERE gmt_create BETWEEN '2026-05-22 00:00:00' AND '2026-05-28 23:59:59'
),
ai_reply AS (
    SELECT COUNT(reply_id) AS reply_count
    FROM log.phx_hsop_osv_ai_reply_log
    WHERE _mt_datetime BETWEEN '2026-05-22 00:00:00' AND '2026-05-28 23:59:59'
      AND ai_msg_recommend_strategy > 0
)
SELECT
    host_survey.host_survey  AS host_survey_cnt,
    ai_reply.reply_count     AS ai_reply_cnt,
