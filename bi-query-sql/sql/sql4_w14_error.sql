WITH host_survey AS (
    ...
    WHERE gmt_create BETWEEN '2026-07-10 00:00:00' AND '2026-07-14 23:59:59'
),
ai_reply AS (
    SELECT COUNT(reply_id) AS reply_count
    FROM log.phx_hsop_osv_ai_reply_log
    WHERE dt BETWEEN '20260710' AND '20260714'
      AND _mt_datetime BETWEEN '2026-07-10 00:00:00' AND '2026-07-14 23:59:59'
      AND ai_msg_recommend_strategy > 0
)
SELECT
    'W14(0710-0714)' AS week_label,
