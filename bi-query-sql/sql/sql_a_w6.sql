...
SELECT
    ...
    ROUND(AVG(d.intelligent_session)*100.0/AVG(d.total_session), 2)        AS session_cover_pct,
    ROUND(AVG(d.ai_msg_cnt)*100.0/NULLIF(AVG(d.total_host_msg),0), 2)     AS msg_cover_pct,
