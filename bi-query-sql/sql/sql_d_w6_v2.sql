WITH unsolved_stats AS (
    ...
    WHERE dt BETWEEN '20260522' AND '20260528'
      AND gmt_create >= '2026-05-22 00:00:00'
      AND gmt_create <  '2026-05-29 00:00:00'
      AND msg_type = 2
),
...
SELECT
    'W6(0522-0528)' AS period,
    (SELECT unresolved_count FROM unsolved_stats)      AS unsolved_feedbacks,
    (SELECT total_survey_count FROM unsolved_stats)    AS total_survey_count,
