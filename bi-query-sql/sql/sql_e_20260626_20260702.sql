WITH host_survey AS (
    ...
    WHERE gmt_create BETWEEN '2026-06-26 00:00:00' AND '2026-07-02 23:59:59'
),
ai_reply AS (
    SELECT COUNT(reply_id) AS reply_count
    FROM log.phx_hsop_osv_ai_reply_log
    WHERE dt BETWEEN '20260626' AND '20260702'
      AND _mt_datetime BETWEEN '2026-06-26 00:00:00' AND '2026-07-02 23:59:59'
