WITH host_survey AS (
    ...
    WHERE gmt_create BETWEEN '2026-06-13 00:00:00' AND '2026-06-19 23:59:59'
),
ai_reply AS (
    SELECT COUNT(reply_id) AS reply_count
    FROM log.phx_hsop_osv_ai_reply_log
    WHERE dt BETWEEN '20260613' AND '20260619'
      AND _mt_datetime BETWEEN '2026-06-13 00:00:00' AND '2026-06-19 23:59:59'
