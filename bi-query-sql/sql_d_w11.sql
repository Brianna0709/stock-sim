-- SQL-D: 智能IM房客点击未解决率 (W11: 2026-06-20 ~ 2026-06-26)
-- dt=统计周最后一天+1天=20260627, gmt_create用实际周范围
...
WITH unsolved_stats AS (
    ...
    WHERE dt = '20260627'
      AND gmt_create >= '2026-06-20 00:00:00'
      AND gmt_create <  '2026-06-27 00:00:00'
      AND msg_type = 2
),
